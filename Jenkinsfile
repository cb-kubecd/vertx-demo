pipeline {
  ...
  stages {
    stage('CI Build and push snapshot') {
      ...
      steps {
        sh 'git rev-parse HEAD; git show-ref; git fetch --unshallow; git rev-parse HEAD; git show-ref; git branch -m $BRANCH_NAME; git rev-parse HEAD; git show-ref; git log'
